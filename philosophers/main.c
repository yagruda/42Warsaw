...
/*   Updated: 2025/09/23 14:48:41 by yhruda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philosophers.h"

static void	cleanup_resources(t_philo *philosophers, t_fork *forks,
		t_table *table)
{
	int	i;
...
static void	join_all_threads(t_philo *philosophers, pthread_t supervisor,
		int n_philos)
{
	int	i;
